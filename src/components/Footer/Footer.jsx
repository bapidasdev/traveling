          ...
          <Col lg='3'>
            ...
            <ListGroup className='footer__quick-links'>
              <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                ...
                <p className='mb-0'>purulia, India</p>
              </ListGroupItem>
              ...
              <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                ...
                <p className='mb-0'>das316456@gmail.com</p>
              </ListGroupItem>
              ...
              <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                ...
                <p className='mb-0'>+918670273082</p>
              </ListGroupItem>
            </ListGroup>
          </Col>

          <Col lg="12" className='text-center pt-5'>
            <p className="copyright">Copyright {year}, design and develop by Bapi Das</p>
          </Col>
        </Row>
      </Container>
    </footer>
